...
const LoginForm = () => {
  ...
  return (
    <div className='m-4'>
        <h1 className='text-center  text-gray-500 font-bold text-2xl '>Login</h1>
       ...
       <button type='submit' className='p-2 rounded-lg text-white mr-20 float-right bg-blue-600 h-10 w-20 place-content-center hover:bg-blue-300 hover:text-gray-900 hover:transition-colors  max-sm:h-9 '>Login</button>
        </form>
    </div>
  )
}
